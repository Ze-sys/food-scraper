...
# Modifying so it takes a 2d feature array when run from within jupyterlab -ze
#Added the following two lines -ze
#import sys
#X = sys.argv[1]
# commented out the following block - ze
#--------------------------------------------------------------
...
def zscale(X, y_full, xlable_,ylable_):
    ...
    def make_plot(item_idx, xlable_, ylable_):
    ...
    make_plot(5, xlable_, ylable_)
    make_plot(6, xlable_, ylable_)
